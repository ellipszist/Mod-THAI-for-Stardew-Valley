...
//        binding.buttonDonation.setOnClickListener(v -> donation());
        binding.buttonDiscord.setOnClickListener(v -> discord());
        binding.buttonFacebook.setOnClickListener(v -> facebook());
...
//    }
    ...
    void discord() {
        CommonLogic.doOnNonNull(this.getContext(), (context) -> CommonLogic.openUrl(context, Constants.RELEASE_URL2));
    }

    void facebook() {
        CommonLogic.doOnNonNull(this.getContext(), (context) -> CommonLogic.openUrl(context, Constants.RELEASE_URL3));
    }
